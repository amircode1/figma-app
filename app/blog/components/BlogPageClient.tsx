    ...
    <div className="min-h-screen bg-[#151515]">
      ...
      <section className="relative h-64 sm:h-80 lg:h-96 bg-gradient-to-r from-[#232323] to-[#151515] flex items-center justify-center">
        <Image
          ...
          alt=""
          fill
          className="bg-[#151515] mask-t-from-0% brightness-[0.6]"
          priority
        />
        <div className="relative text-center text-white z-10 px-4">
          ...
          <p className="text-base sm:text-lg lg:text-xl opacity-90">
            آخرین مقالات و اخبار دنیای قهوه
          </p>
        </div>
      </section>
      {/* Blog Grid */}
      <section className="max-w-6xl mx-auto py-8 sm:py-12 px-4 sm:px-6 grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
        {blogs.map((blog) => (
          <div
            key={blog.id}
            className="rounded-2xl overflow-hidden bg-[#151515] shadow-lg"
          >
            ...
            <div className="p-4">
              <h3 className="font-bold text-[17px] mb-1 text-white">
                {blog.title}
              </h3>
              ...
              <div className="mt-4 flex justify-between items-center">
                <span className="text-[#C6A15B] text-xs">
                  دسته: {blog.category}
                </span>
